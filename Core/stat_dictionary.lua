quantify.STATS = {
  ...
  ["raw:guild_tax"] = {text = "Guild Tax", units="money", order = 900, version="retail"},
  ...
  ["session_rates:guild_tax"] = {text = "Guild Tax Per Hour", units="money/hour", order = 901, version="retail"},
  ...
  ["raw:group_xp"] = {text = "Bonus Group XP", units = "integer", version="retail"},
